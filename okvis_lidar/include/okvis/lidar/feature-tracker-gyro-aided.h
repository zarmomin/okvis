#ifndef OKVIS_LIDAR_FEATURE_TRACKER_GYRO_AIDED_H_
#define OKVIS_LIDAR_FEATURE_TRACKER_GYRO_AIDED_H_
...
public:
  ...
  explicit FeatureTrackerGyroAided(const aslam::NCamera &camera_system,
                                   FeatureTrackingPipelineBase *track_pipeline);

  bool processNFrame(Eigen::Matrix<int64_t, 1, Eigen::Dynamic>
  ...
  void setCurrentImuBias(int64_t timestamp_ns,
...
#endif // OKVIS_LIDAR_FEATURE_TRACKER_GYRO_AIDED_H_

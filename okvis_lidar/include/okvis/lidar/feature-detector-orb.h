#ifndef OKVIS_LIDAR_FEATURE_DETECTOR_ORB_H_
#define OKVIS_LIDAR_FEATURE_DETECTOR_ORB_H_
...
public:
  ...
  virtual std::string getDetectorName() const { return "orb"; }
...
#endif // OKVIS_LIDAR_FEATURE_DETECTOR_ORB_H_

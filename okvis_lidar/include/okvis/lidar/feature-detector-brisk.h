#ifndef OKVIS_LIDAR_FEATURE_DETECTOR_BRISK_H_
#define OKVIS_LIDAR_FEATURE_DETECTOR_BRISK_H_
#include <memory>
#include <string>
...
public:
  ...
  virtual std::string getDetectorName() const { return "brisk"; }
...
#endif // OKVIS_LIDAR_FEATURE_DETECTOR_BRISK_H_

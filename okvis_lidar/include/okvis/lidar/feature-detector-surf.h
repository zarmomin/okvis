#ifndef OKVIS_LIDAR_FEATURE_DETECTOR_SURF_H_
#define OKVIS_LIDAR_FEATURE_DETECTOR_SURF_H_
#include <memory>
#include <string>
...
public:
  ...
  virtual std::string getDetectorName() const { return "surf"; }
...
#endif // OKVIS_LIDAR_FEATURE_DETECTOR_SURF_H_

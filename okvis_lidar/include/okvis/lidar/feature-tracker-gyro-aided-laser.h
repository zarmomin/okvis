#ifndef OKVIS_LIDAR_FEATURE_TRACKER_GYRO_AIDED_LASER_H_
#define OKVIS_LIDAR_FEATURE_TRACKER_GYRO_AIDED_LASER_H_
...
namespace okvis { namespace lidar {
...
class FeatureTrackerGyroAidedLaser {
 public:
  ...
  bool processNFrame(
      ...
      const aslam::Quaternion& q_Ikp1_Ik,
...
}  // namespace lidar } // namespace okvis

#endif  // OKVIS_LIDAR_FEATURE_TRACKER_GYRO_AIDED_LASER_H_

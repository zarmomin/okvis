#ifndef OKVIS_LIDAR_FEATURE_DETECTOR_SIFT_H_
#define OKVIS_LIDAR_FEATURE_DETECTOR_SIFT_H_
#include <memory>
#include <string>
...
FeatureDetectorSiftSettings InitFeatureDetectorSiftSettingsFromGFlags() {
  ...
  settings.contrast_threshold =
      FLAGS_NEW_feature_tracker_sift_contrast_threshold;
...
public:
  ...
  virtual std::string getDetectorName() const { return "sift"; }
...
#endif // OKVIS_LIDAR_FEATURE_DETECTOR_SIFT_H_

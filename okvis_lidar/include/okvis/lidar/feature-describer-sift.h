#ifndef OKVIS_LIDAR_FEATURE_DESCRIBER_SIFT_H_
#define OKVIS_LIDAR_FEATURE_DESCRIBER_SIFT_H_
...
public:
  ...
  virtual std::string getDescriptorName() const { return "sift"; }
...
#endif // OKVIS_LIDAR_FEATURE_DESCRIBER_SIFT_H_

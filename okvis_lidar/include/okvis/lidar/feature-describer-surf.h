#ifndef OKVIS_LIDAR_FEATURE_DESCRIBER_SURF_H_
#define OKVIS_LIDAR_FEATURE_DESCRIBER_SURF_H_
...
public:
  ...
  virtual std::string getDescriptorName() const { return "surf"; }
...
#endif // OKVIS_LIDAR_FEATURE_DESCRIBER_SURF_H_
